...
export default function DashboardPage() {
  ...
  const [openAccountsModal, setOpenAccountsModal] = useState<boolean>(false);
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 mb-4">
              <button
                ...
                className="flex flex-row items-center gap-2 px-4 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white text-sm font-semibold transition-all shadow-lg shadow-purple-600/20"
              >
                <PlusCircle /> Add a new Account
              </button>
            </div>
          </div>
